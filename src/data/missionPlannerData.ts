...
export const SAMPLE_WAYPOINTS: Waypoint[] = [
  ...
  },
  {
    ...
    targetDepthCm: 0,
    targetSpacingCm: 18.0,
    label: 'Headland Turn 1 (Seeder OFF)',
  },
  // Row 2 (Southbound)
  {
    index: 4,
